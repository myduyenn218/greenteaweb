    ...
    <main>
        <div class="container-fluid">
            ...
            <section>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-c-tabs">
                                ...
                                <ul class="nav md-tabs tabs-2 light-blue darken-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#panel77" role="tab"><i
                                                class="fas fa-user mr-1"></i>
                                            Public info</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#panel88" role="tab"><i
                                        ...
                                        <div class="modal-body mb-1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <!-- Description -->
                                                    <div class="md-form">
                                                        <textarea type="text" id="editProfile7"
                    ...
                    <div class="modal-dialog cascading-modal" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body mb-0">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quam quibusdam modi
                                    veritatis
                                    non
                                    accusamus distinctio consequuntur aliquam, assumenda tempore in illum aspernatur
                                    quia,
                            ...
                            <div class="modal-footer justify-content-center">
                                <button type="button" class="btn btn-outline-primary"
                                    data-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-primary">Go to <i
                ...
                <div class="modal fade" id="modalContactUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog cascading-modal modal-lg" role="document">
                    ...
                    <div class="modal-dialog cascading-modal" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-center">
                                <button type="button" class="btn btn-outline-primary"
                                    data-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-primary">Submit <i
                                        class="fas fa-check ml-1"></i></button>
                            </div>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <section class="card profile-card mb-4 text-center">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Social -->
                                <a type="button" class="btn-floating btn-small"><i
                                        class="fab fa-facebook-f grey-text"></i></a>
                                <a type="button" class="btn-floating btn-small"><i
                                        class="fab fa-twitter grey-text"></i></a>
                                <a type="button" class="btn-floating btn-small"><i
                                        class="fab fa-linkedin-in grey-text"></i></a>

                                <!-- Text -->
                                <p class="card-text mt-3">Some quick example text to build on the card title and make up
                                    the
                                    bulk of
                                    the card's content.
                                </p>
                                ...
                                <button type="button" class="btn btn-info btn-rounded btn-sm" data-toggle="modal"
                                    data-target="#modalContactUser">Contact<i
                        ...
                        <section class="card mb-4">
                            <div class="card-body text-center">
                                ...
                                <button type="button" class="btn btn-light-blue btn-rounded btn-sm px-3"
                                    data-toggle="modal" data-target="#modalAchievment">Bootstrap Master</button>
                                <button type="button" class="btn btn-blue-grey btn-rounded btn-sm px-3"
                                    data-toggle="modal" data-target="#modalAchievment">WordPress
                                    Master</button>
                                <button type="button" class="btn btn-default btn-rounded btn-sm px-3"
                                    data-toggle="modal" data-target="#modalAchievment">Angular
                                    Master</button>
                                <button type="button" class="btn btn-secondary btn-rounded btn-sm px-3"
                                    data-toggle="modal" data-target="#modalAchievment">MDB
                                    Expert</button>
                                <button type="button" class="btn btn-deep-purple btn-rounded btn-sm px-3"
                                    data-toggle="modal" data-target="#modalAchievment">Community contributor</button>
                                <button type="button" class="btn btn-indigo btn-rounded btn-sm px-3" data-toggle="modal"
                                    data-target="#modalAchievment">MDB
                                    Pro User</button>
                            </div>
                        </section>
                        <!-- Section: Achievements -->
                    ...
                    <div class="col-lg-8 col-md-12 text-center">
                        ...
                        <div class="text-center mt-3 mb-5">
                            ...
                            <button type="button" class="btn btn-info btn-rounded mt-4" data-toggle="modal"
                                data-target="#modalSubmitProject">Submit
